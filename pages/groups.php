  ...
  <div class="container py-5">
    ...
    <div class="row g-3 justify-content-start">
      <?php foreach ($groups as $gi => $grp):
        ...
        $typeBadgeClass = ['study'=>'badge-study','project'=>'badge-project','forum'=>'badge-forum'];
        $mc = (int)$grp['member_count'];
      ?>
      <div class="col-lg-4 col-md-6">
        <div class="cc-group-card reveal d<?= ($gi % 3) + 1 ?>" data-type="<?= e($grp['type']) ?>">
          <div class="cc-group-banner">
            ...
            <span class="cc-group-type-badge <?= $typeBadgeClass[$grp['type']] ?? '' ?>"><?= ucfirst(e($grp['type'])) ?></span>
          ...
          <div class="cc-group-body">
            <div class="d-flex justify-content-between align-items-center mb-2">
              ...
              <span class="cc-group-members"><i class="fas fa-users me-1"></i><?= $mc ?> <?= $mc === 1 ? 'member' : 'members' ?></span>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <?php if ($joined): ?>
              <span style="display:inline-flex;align-items:center;padding:7px 16px;border:1.5px solid var(--moss);color:var(--moss);font-size:.73rem;font-weight:600;text-transform:uppercase;letter-spacing:.05em;">
                ✓ Joined
              </span>
              ...
              <?php else: ?>
              <a href="login.php" class="cc-group-join" style="display:inline-flex;align-items:center;">Join</a>
              <?php endif; ?>
            </div>
          </div>
        </div>
